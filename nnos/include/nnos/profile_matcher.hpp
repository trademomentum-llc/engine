...
public:
    ...
    struct FeatureWeights {
        float need_for_structure;
        float novelty_seeking;
        float hyperfocus_inclination;
        float sensory_sensitivity_level;
        float social_energy_capacity;
        float executive_function_difficulty;
        FeatureWeights()
            : need_for_structure(1.0f), novelty_seeking(1.0f),
              hyperfocus_inclination(1.5f), sensory_sensitivity_level(1.5f),
              social_energy_capacity(1.0f), executive_function_difficulty(1.5f) {}
    };
